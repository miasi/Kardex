...
public class HorarioMa extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.horario_ma);
        CreadorMenu();
    }
    ...
    private void CreaActivities(int pos) {
        switch (pos)
        {
            ...
            case 3:
            {
                Intent i = new Intent(HorarioMa.this, Horario.class);
                startActivity(i);
                break;
            }
            //Horario Maestros
            case 4:
            {
                Intent i = new Intent(HorarioMa.this, HorarioMa.class);
                startActivity(i);
                break;
            }
            //Mapa
        ...
        Toast toast = Toast.makeText(HorarioMa.this, titulos[pos-1], Toast.LENGTH_SHORT);
        toast.show();
    }
