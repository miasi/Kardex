...
public class Main2Activity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private void CreaActivities(int pos) {
        switch (pos)
        {
            ...
            case 2:
            {
                Intent i = new Intent(Main2Activity.this, Calificaciones.class);
                startActivity(i);
                break;
            }
            //Horario
            case 3:
            {
                Intent i = new Intent(Main2Activity.this, Horario.class);
                startActivity(i);
                break;
            }
            //Horario Maestros
            case 4:
            {
                Intent i = new Intent(Main2Activity.this, HorarioMa.class);
                startActivity(i);
                break;
            }
            //Mapa
            case 5:
            {
                Intent i = new Intent(Main2Activity.this, Mapa.class);
                startActivity(i);
                break;
            }
            //Salir
        ...
        Toast toast = Toast.makeText(Main2Activity.this, titulos[pos-1], Toast.LENGTH_SHORT);
        toast.show();
    }
